...
class OneStore {
	...
	public static function load_customize_settings() {
		...
		require_once ONESTORE_INCLUDES_DIR . '/customizer/settings/general-styles.php';
		require_once ONESTORE_INCLUDES_DIR . '/customizer/settings/layout.php';
		require_once ONESTORE_INCLUDES_DIR . '/customizer/settings/header-bars.php';
		require_once ONESTORE_INCLUDES_DIR . '/customizer/settings/header-mobile-bars.php';
		require_once ONESTORE_INCLUDES_DIR . '/customizer/settings/mobile-canvas.php';
		require_once ONESTORE_INCLUDES_DIR . '/customizer/settings/page-header.php';
		require_once ONESTORE_INCLUDES_DIR . '/customizer/settings/off-canvas.php';
		require_once ONESTORE_INCLUDES_DIR . '/customizer/settings/footer-widgets.php';
		require_once ONESTORE_INCLUDES_DIR . '/customizer/settings/footer-bars.php';
	}
	...
	public function register_widgets() {
		...
		require ONESTORE_INCLUDES_DIR . '/widgets/tab-api.php';
		...
		require_once ONESTORE_INCLUDES_DIR . '/widgets/class-widget-builder-posts.php';
	...
	public function get_settings_defaults() {
		...
		$this->setting_defaults = apply_filters( 'onestore/customizer/setting_defaults', $this->setting_defaults );
	...
	public function add_dynamic_css( $css ) {
		...
		OneStore_Customizer::load_setup();

		$defaults = $this->get_settings_defaults();
		$postmessages = include ONESTORE_INCLUDES_DIR . '/customizer/postmessages.php';
		$more_settings = OneStore_Customizer::get_css_live();
		foreach ( $more_settings as $k => $v ) {
			$postmessages[ $k ] = $v;
		}
		$postmessages = array_merge( $postmessages, $more_settings );
