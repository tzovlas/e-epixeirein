...
function onestore_get_default_value( $index, $fallback = null ) {

	$array = OneStore()->get_settings_defaults();
...
function onestore_get_theme_modules() {
	return array(
		'page-container' => array(
			'label'    => esc_html__( 'Site Layout', 'onestore' ),
			'category' => 'layout',
			'actions'  => array(
				'settings' => array(
					'label' => esc_html__( 'Customize', 'onestore' ),
					'url'   => add_query_arg( array( 'autofocus[section]' => 'onestore_section_layout' ), admin_url( 'customize.php' ) ),
				),
			),
		),
		'header' => array(
		...
		'content-sidebar' => array(
			...
			'actions'  => array(
				'settings' => array(
					'label' => esc_html__( 'Customize', 'onestore' ),
					'url'   => add_query_arg( array( 'autofocus[panel]' => 'onestore_section_layout' ), admin_url( 'customize.php' ) ),
				),
			),
		),
		'footer' => array(
		...
		'footer_widgets' => array(
			'label'    => esc_html__( 'Footer Widgets', 'onestore' ),
			'category' => 'layout',
			'actions'  => array(
				'settings' => array(
					'label' => esc_html__( 'Customize', 'onestore' ),
					'url'   => add_query_arg( array( 'autofocus[section]' => 'onestore_section_footer_widgets_bar' ), admin_url( 'customize.php' ) ),
				),
			),
		),
		'page-settings' => array(
		...
		'general-styles' => array(
			...
			'actions'  => array(
				'settings' => array(
					'label' => esc_html__( 'Customize', 'onestore' ),
					'url'   => add_query_arg( array( 'autofocus[panel]' => 'onestore_section_general_styles' ), admin_url( 'customize.php' ) ),
				),
			),
		),
		'google-fonts' => array(
		...
		'woocommerce' => array(
			'label'    => esc_html__( 'WooCommerce Layout', 'onestore' ),
	...
	return apply_filters(
		...
		array(
			...
			'woocommerce-variation-swatches' => array(
				'label'    => esc_html__( 'WC Variation Swatches', 'onestore' ),
				'category' => 'woocommerce',
				'url'      => esc_url( $url . '' ),
			),
			'woocommerce-variation-gallery' => array(
				'label'    => esc_html__( 'WC Variation Gallery', 'onestore' ),
				'category' => 'woocommerce',
				'url'      => esc_url( $url . '' ),
			),
			'woocommerce-elementor-wc-tabs' => array(
				'label'    => esc_html__( 'Elementor Product Tabs', 'onestore' ),
				'category' => 'woocommerce',
				'url'      => esc_url( $url . '' ),
			),
			'woocommerce-elementor-wc-products' => array(
				'label'    => esc_html__( 'Elementor Products', 'onestore' ),
				'category' => 'woocommerce',
				'url'      => esc_url( $url . '' ),
			),

			'blog-elementor' => array(
				'label'    => esc_html__( 'Elementor Blog Posts', 'onestore' ),
				'category' => 'blog',
				'url'      => esc_url( $url . '' ),
			),
