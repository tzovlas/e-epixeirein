		...
		array(
			...
			'choices'     => apply_filters(
				...
				array(
					...
					// Hot line.
					'hotline'                 => '<span class="dashicons dashicons-phone"></span>' . esc_html__( 'Hotline', 'onestore' ),
...
foreach ( OneStore_Customizer::get_mobile_header_rows() as $row_id => $label ) { 
	$settings[ 'mobile_'.$row_id.'_left' ] = $key . '_'.$row_id.'_left';
	$settings[ 'mobile_'.$row_id.'_center' ] = $key . '_'.$row_id.'_center';
	$settings[ 'mobile_'.$row_id.'_right' ] = $key . '_'.$row_id.'_right';
}
$settings['mobile_vertical_top'] = $key . '_vertical_top';
	...
	new OneStore_Customize_Control_Builder(
		...
		array(
			...
			'labels'      => array(
				...
				'mobile_top_left'    => is_rtl() ? esc_html__( 'Right', 'onestore' ) : esc_html__( 'Left', 'onestore' ),
				'mobile_top_center'  => esc_html__( 'Center', 'onestore' ),
				'mobile_top_right'   => is_rtl() ? esc_html__( 'Left', 'onestore' ) : esc_html__( 'Right', 'onestore' ),
				...
				'mobile_bottom_left'    => is_rtl() ? esc_html__( 'Right', 'onestore' ) : esc_html__( 'Left', 'onestore' ),
				'mobile_bottom_center'  => esc_html__( 'Center', 'onestore' ),
				'mobile_bottom_right'   => is_rtl() ? esc_html__( 'Left', 'onestore' ) : esc_html__( 'Right', 'onestore' ),
