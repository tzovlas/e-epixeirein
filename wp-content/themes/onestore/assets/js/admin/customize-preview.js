...
(function ($) {
    ...
    var onestoreCustomizer = {
        ...
        postMessage_css: function (key, rules, newValue) {
            ...
            _.each(rules, function (rule) {
                ...
                cssArray[rule["media"]][rule["element"]][rule["property"]] =
                    formattedValue;
            });
    ...
    if (undefined !== onestoreCustomizerPreviewData) {
        if (undefined !== onestoreCustomizerPreviewData.postMessages) {
            console.log( 'onestoreCustomizerPreviewData', onestoreCustomizerPreviewData );
            _.each(
    ...
    $document.on(
        ...
        function (e, key, value) {
            if ( ['woocommerce_single_gallery_width'].indexOf( key ) > -1 ) {
