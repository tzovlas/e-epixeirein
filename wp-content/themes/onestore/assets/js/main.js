(function () {
    ...
    const mobileMenuEl = document.querySelector("#mobile-vertical-header");
    const mobileMenuContentEl = document.querySelector(
    ...
    window.onestore = {
        ...
        initDropdownMenuReposition: function () {
            ...
            var calculateSubMenuEdge = function () {
                ...
                $submenus.forEach(function ($submenu) {
                    ...
                    var containerEdge =
                            $container.getBoundingClientRect()[anchorSide],
                        submenuEdge =
                            $submenu.getBoundingClientRect()[anchorSide],
        ...
        addSubMenuHeading: function () {
            ...
            for (let i = 0; i < submenus.length; i++) {
                ...
                let letButton =
                    parent.querySelector(".sub-menu-toggle").innerHTML;
        ...
        initGlobalPopup: function () {
            ...
            var handlePopupToggle = function (e) {
                ...
                if ($target.classList.contains("popup-active")) {
                    ...
                    setTimeout(function () {
                        ...
                        $target.focus();
                        if (id === "off-canvas-search") {
                            $target.querySelector(".search-field").focus();
                        }
                    }, 300);
            ...
            // onestoreConfig.breakpoints.mobile
            ...
            var handleResponsiveVisibility = function (e) {
                ...
                let r = mobileMenuContentEl.getBoundingClientRect();
                mobileMenuContentEl.style.clip = `rect(0, ${r.width}px, auto, 0)`;
            };
